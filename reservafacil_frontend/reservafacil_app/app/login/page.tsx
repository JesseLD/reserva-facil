        ...
        <form action="#" method="post">
          <div className="w-full h-dvh flex items-center justify-center flex-col gap-2 p-4">
            <div className="w-full flex flex-col items-center gap-2 p-2 rounded-lg ">
              ...
              <Button className="my-2 w-full"> Entrar</Button>

              <p className="text-neutral-400 my-2 font-bold cursor-pointer">
                Ou
              </p>
              <p className="text-neutral-400 font-bold cursor-pointer text-md text-center">
                Não tem uma conta?{" "}
                <Link
                  href={"/register"}
                  className="text-orange-500 font-bold hover:underline transition-all"
