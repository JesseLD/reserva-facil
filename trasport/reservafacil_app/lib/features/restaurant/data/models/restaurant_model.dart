...
class RestaurantModel {
  ...
  factory RestaurantModel.fromMap(Map<String, dynamic> map) {
    return RestaurantModel(
      ...
      double.parse(map['priceRangeStart'].toString()),
      double.parse(map['priceRangeEnd'].toString()),
      map['capacity'] as int,
    );
  }
  ...
  @override
  String toString() {
    return 'RestaurantModel(id: $id, name: $name, logoUrl: $logoUrl, rating: $rating, category: $category, isFavorite:  priceRangeStart: $priceRangeStart, priceRangeEnd: $priceRangeEnd, capacity: $capacity)';
  }
