  ...
  return (
    <>
      <section className="hidden md:flex ">
        ...
        >
          <Image src={`/logo_big_w.png`} alt="" width={600} height={100} className="pointer-events-none" />
        </div>
        <div className="w-full h-screen flex items-center justify-center flex-col gap-2 p-8">
          <div className="w-[500px] flex flex-col gap-4 shadow-lg p-8 rounded-lg ">
            ...
            <Link href={"/login"}><Button text="Sou cliente" variant="primary" className="my-2"/></Link>
            <Link href={"/register"}><Button text="Criar Conta" variant="secondary" /></Link>
          </div>
        </div>
      </section>
      ...
      <section className="flex md:hidden">
        ...
        >
          <Image src={`/logo_big_w.png`} alt="" width={200} height={100} className="mt-8 pointer-events-none"/>
